    ...
    <>
      <main className="flex flex-col items-center justify-center">
        <div className="relative">
          ...
          />
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[83.5%] py-[7.3%] px-0">
            <Search></Search>
          </div>
        </div>

        <section className="justify-center w-full max-w-320">
          <h2 className="text-2xl font-bold border-l-4 border-orange-500 pl-4 mb-6">
          ...
          <div className="relative">
            ...
            >
              <img src={back} alt="prev" className="w-7 h-7" />
            </button>
            <button
              id="continueListButton"
              className="absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-white shadow-lg p-2 rounded-full"
            >
              <img src={continuebutton} alt="next" className="w-7 h-7" />
            </button>
              ...
              <div className="flex gap-5 justify-center">
                <div className="flex-shrink-0 w-64  bg-white shadow rounded-lg overflow-hidden">
                  ...
                  <div className="p-4 text-center">
                    ...
                    <p className="text-blue-700">150.000đ</p>
                  </div>
                </div>
                <div className="flex-shrink-0 w-64 bg-white shadow rounded-lg overflow-hidden">
                  <img
                  ...
                  />
                  <div className="p-4 text-center">
                    <p className="font-bold text-green-800">Sài Gòn – Mũi Né</p>
                    <p className="text-blue-700">180.000đ</p>
                  </div>
                </div>
                <div className="flex-shrink-0 w-64 bg-white shadow rounded-lg overflow-hidden">
                  <img
                  ...
                  <div className="p-4 text-center">
                    ...
                    <p className="text-blue-700">240.000đ</p>
                  </div>
                </div>
                <div className="flex-shrink-0 w-64 bg-white shadow rounded-lg overflow-hidden">
                  <img
                  ...
                  />
                  <div className="p-4 text-center">
                    <p className="font-bold text-green-800">Sài Gòn – Đà Lạt</p>
                    <p className="text-blue-700">200.000đ</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="flex justify-center gap-8 mt-4 lg:hidden">
            <button id="backListButton2">
              <img src={back} alt="prev" className="w-7 h-7" />
            </button>
            <button id="continueListButton2">
              <img src={continuebutton} alt="next" className="w-7 h-7" />
            </button>
          </div>
        </section>
        ...
        <section className="px-4 py-12">
          <h2 className="text-2xl font-bold border-l-4 border-orange-500">
            Ưu Đãi Nổi Bật
          </h2>{" "}
          <br />
          <div className="flex items-center gap-6">
            <button id="discountBackButton" className="lg:hidden">
              <img
            ...
            <button id="discountContinueButton" className="lg:hidden">
              <img
                src="/assets/icons/continue.png"
                alt="next"
                className="w-7 h-7"
              />
            </button>
        ...
        <section className="max-w-7xl mx-auto px-4 py-12 justify-center max-w-320 w-full">
          ...
          <div className="relative">
            <button
              id="busListBackButton"
              className="absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-white shadow-lg p-2 rounded-full"
            >
              <img src={back} alt="prev" className="w-7 h-7" />
            </button>
            <button
              id="busListContinueButton"
              className="absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-white shadow-lg p-2 rounded-full"
            >
              <img src={continuebutton} alt="next" className="w-7 h-7" />
            </button>
          ...
          <div className="flex justify-center gap-8 mt-4 lg:hidden">
            ...
            <button id="busListContinueButton2">
              <img
                src="/assets/icons/continue.png"
                alt="next"
                className="w-7 h-7"
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-12 gap-3 lg:gap-4">
              <div className="col-span-2 md:col-span-3 lg:col-span-8 relative overflow-hidden shadow-lg">
                ...
                <div className="absolute bottom-5 left-6 text-white">
                  <h3 className="text-2xl lg:text-3xl font-bold drop-shadow-2xl">
                    Sài Gòn
                  </h3>
                  <p className="text-lg lg:text-xl drop-shadow-2xl">
                    287 bài viết
                  </p>
                </div>
              </div>
              ...
              <div className="col-span-1 lg:col-span-4 relative overflow-hidden">
                <div className="col-span-1 lg:col-span-3 relative overflow-hidden shadow-lg">
                  ...
                  />
                  <div className="absolute bottom-5 left-6 text-white">
                    <h3 className="text-xl lg:text-2xl font-bold drop-shadow-2xl">
                      Đà Lạt
                    </h3>
              ...
              <div className="col-span-2 lg:col-span-8 relative overflow-hidden shadow-lg">
                ...
                />
                <div className="absolute bottom-5 left-6 text-white">
                  <h3 className="text-3xl lg:text-4xl font-bold drop-shadow-2xl">
                    Nha Trang
                  </h3>
                  <p className="text-xl lg:text-2xl drop-shadow-2xl">
                    557 bài viết
                  </p>
                </div>
              </div>
        ...
        <section className="max-w-7xl mx-auto px-4 py-12 w-full">
          ...
          <div className="relative justify-center">
            <button
              id="busStationBackButton"
              className="absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-white shadow-lg p-2 rounded-full"
            >
              <img src={back} alt="prev" className="w-7 h-7" />
            </button>
            <button
              id="busStationContinueButton"
              className="absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-white shadow-lg p-2 rounded-full"
            >
              <img src={continuebutton} alt="next" className="w-7 h-7" />
            </button>
          ...
          <div className="flex justify-center gap-8 mt-4 lg:hidden">
            <button id="busStationBackButton2">
              <img
                src="/assets/icons/back.png"
                alt="prev"
                className="w-7 h-7"
            ...
            <button id="busStationContinueButton2">
              <img
                src="/assets/icons/continue.png"
                alt="next"
                className="w-7 h-7"
        ...
        <section className="bg-white py-16 w-full max-w-320">
          <div className="max-w-7xl mx-auto px-4">
            <h2 className="text-2xl font-bold border-l-4 border-orange-500 pl-4 mb-10 inline-block">
            ...
            <div className="grid gap-10">
              <div className="flex items-center gap-6 ">
                <div className="flex items-center gap-6 justify-center">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-sm text-gray-600">
                      Với hơn 5000+ tuyến đường và 1500+ nhà xe trên khắp cả
                      nước
                    </p>
                  </div>
                </div>
                <div className="flex items-center gap-6 justify-center">
                  ...
                  <div className="text-left">
                    <p className="font-bold text-lg">ĐẢM BẢO CÓ VÉ</p>
                    <p className="text-sm text-gray-600">
              ...
              <div className="flex items-center gap-25">
                <div className="flex items-center gap- justify-center">
                  ...
                  <div className="text-left">
                    <p className="font-bold text-lg">CAM KẾT GIỮ VÉ</p>
                    <p className="text-sm text-gray-600">
                ...
                <div className="flex items-center gap-7 justify-center">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-sm text-gray-600">
                      Giải quyết kịp thời vấn đề của khách hàng một cách nhanh
                      chóng
                    </p>
                  </div>
                </div>
