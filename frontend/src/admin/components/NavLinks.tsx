  ...
  return (
    <div className="dashboard-left ">
      ...
      <div className="list-manager">
        ...
        <NavLink end className="dropdown-item" to="/admin/cancel">Quản lý Hủy Vé</NavLink>
        <NavLink end className="dropdown-item" to="/admin/review">Quản lý Đánh Giá</NavLink>
        <NavLink end className="dropdown-item" to="/admin/banner">Quản lý Banner</NavLink>
        <NavLink end className="dropdown-item" to="/admin/paymentProvider">Quản lý Nhà Thanh Toán</NavLink>
