    ...
    <div>
      <div className="header-page flex flex-col gap-3 ">
        ...
        dataSource={bookings}>
          ...
          />
          <Column title="Ngày tạo" dataIndex="created_at" key="created_at" render={(value: Date) => value.toLocaleString()} />
          <Column title="Ngày cập nhật" dataIndex="updated_at" key="updated_at" render={(value: Date) => value.toLocaleString()} />
          <Column
            title="Action"
            key="action"
